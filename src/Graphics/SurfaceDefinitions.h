...
struct DebugLine : insigne::renderable_surface_t<DebugLine> {
	...
	static void describe_vertex_data()
	{
		...
		detail::enable_vertex_attrib(0);
		detail::enable_vertex_attrib(1);
		detail::describe_vertex_data(0, 3, data_type_e::elem_signed_float, false, sizeof(DebugLine), (const voidptr)0);
		detail::describe_vertex_data(1, 4, data_type_e::elem_signed_float, false, sizeof(DebugLine), (const voidptr)12);
	}
};

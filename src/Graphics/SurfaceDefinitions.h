...
struct GlyphSurface
{
	...
	static void describe_vertex_data()
	{
		...
		detail::describe_vertex_data(0, 3, data_type_e::elem_signed_float, false, sizeof(GlyphVertex), (const voidptr)0);
		detail::describe_vertex_data(1, 4, data_type_e::elem_signed_float, false, sizeof(GlyphVertex), (const voidptr)12);
		detail::describe_vertex_data(2, 4, data_type_e::elem_signed_float, false, sizeof(GlyphVertex), (const voidptr)28);
	}
};
...
struct SurfacePNC {
	...
	static void setup_states()
	{
		using namespace insigne;
		detail::set_blending<false_type>(blend_equation_e::func_add, factor_e::fact_src_alpha, factor_e::fact_one_minus_src_alpha);
		detail::set_cull_face<true_type>(face_side_e::back_side, front_face_e::face_cw);
		detail::set_depth_test<true_type>(compare_func_e::func_less_or_equal);
		detail::set_depth_write<true_type>();
		detail::set_scissor_test<false_type>(0, 0, 0, 0);
	}

...
uniform sampler2D u_TransmittanceTex;
uniform sampler2D u_IrradianceTex;
uniform sampler3D u_ScatteringTex;
...
#define RADIANCE_API_ENABLED
    ...
    RadianceSpectrum GetSkyRadiance(
      ...
      return GetSkyRadiance(ATMOSPHERE, u_TransmittanceTex,
          u_ScatteringTex, single_mie_scattering_texture,
          camera, view_ray, shadow_length, sun_direction, transmittance);
    }
    RadianceSpectrum GetSkyRadianceToPoint(
        Position camera, Position point, Length shadow_length,
        Direction sun_direction, out DimensionlessSpectrum transmittance) {
      return GetSkyRadianceToPoint(ATMOSPHERE, u_TransmittanceTex,
          u_ScatteringTex, single_mie_scattering_texture,
    ...
    IrradianceSpectrum GetSunAndSkyIrradiance(
       ...
       out IrradianceSpectrum sky_irradiance) {
      return GetSunAndSkyIrradiance(ATMOSPHERE, u_TransmittanceTex,
          u_IrradianceTex, p, normal, sun_direction, sky_irradiance);
    }
    #endif
    ...
    Illuminance3 GetSunAndSkyIlluminance(
      ...
      IrradianceSpectrum sun_irradiance = GetSunAndSkyIrradiance(
          ATMOSPHERE, u_TransmittanceTex, u_IrradianceTex, p, normal,
...
void main()
{
  ...
  vec3 transmittance;
  vec3 radiance = GetSkyRadiance(camera - earth_center, view_direction, /*shadow_length*/ 0.0, sun_direction, transmittance);
